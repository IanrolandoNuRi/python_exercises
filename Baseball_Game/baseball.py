...
def _handler_item_input(final_game_score : list, element_from_gaming_score: chr) -> list:
    try: 
        ...
        if element_from_gaming_score == constants.remove_previous_score: 
            ...
            else: return constants.error_found_1
        ...
        if element_from_gaming_score == constants.sum_previous_two_scores: 
            ...
            else: return constants.error_found_2
...
def _iterate_given_board(game_score_board: list) -> list or int:
    ...
    for score in game_score_board:
        ...
        if(final_game_score == 1 or final_game_score == 2): return final_game_score
